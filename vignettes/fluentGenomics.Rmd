...
cached *SummarizedExperiment* object from the normalised ATAC-seq data provided
by @alasooZenodo. This object contains all 145 ATAC-seq samples accross all
...
*SummarizedExperiment* object containing ATAC-seq peaks can be created from the
following tab-delimited files in [@alasooZenodo]:
...
the workflow and all dowstream dependencies can be installed
