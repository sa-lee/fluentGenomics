...
The *plyranges* package is used to perform easily-readable transformations of data
...
described by @granges. The *tximeta* package described by @Love2019-tximeta is
