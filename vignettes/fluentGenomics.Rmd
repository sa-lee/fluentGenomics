...
time. For brevity we will label these genes as `other_genes`, and
later on we will use these for comparison with our `de_genes` set. 
...
Then for all variables except for the `origin` column we divide
