...
We place the matrix into the assays slot as a named list; we place
the annotated peaks into the rowwise ranges slot; and the sample
metadata into the columnwise data slot:
